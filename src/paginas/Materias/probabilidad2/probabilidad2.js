  ...
  return (
    ...
    <div>
        <div class = "Box"> 
            <div class="box1">
                <div class="boox1">
                    <h1> 11310031 - Probabilidad y Estadística II</h1>
                </div>
                <div class="boox1">
            ...
            <div class="box1"> 
                <div class="boox1">
                    ...
                    <ul> 
                    <Link to='../../Profesor/AnaBeltran/AnaBeltran'><li>Ana Maria Beltran</li></Link>
                    <Link to='../../Profesor/DavidAndrade/DavidAndrade'><li>David Eugenio Andrade</li></Link>
                    </ul>
                </div>
            </div>
            ...
            <div class ="box2">
                <div class="boox2">
                    <h1>Repositorios de Probabilidad y Estadística II</h1>

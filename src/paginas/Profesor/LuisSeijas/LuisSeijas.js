...
function Profesor1() {
  return (
    ...
    <div class="Perfil">
        <div class="box">
        <h1>Perfil de Luis Eduardo Seijas</h1>
            <div class="Interbox">
                <div class="top"> 
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
                <Link to = "/Materias/programacion">Programación de computadores</Link>
                <br></br>
                <Link to = "/Materias/algoritmos">Algoritmos y estructuras de datos</Link>
            </div>
        </div>
    </div>

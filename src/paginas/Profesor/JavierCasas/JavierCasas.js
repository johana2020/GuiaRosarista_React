        ...
        <h1>Perfil de Profesor1</h1>
            <div class="Interbox">
                <div class="top"> 
                    ...
                    <div class ="right">
                        <p><strong>Calificación general:</strong> 4.1/5.0</p>
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong>  Javier Casas</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong>  Javier.Casas@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
                <Link to = "../../Materias/ingeniriaDatos/ingeniriaDatos">Ingeniería de datos</Link>
            </div>
        </div>
    </div>

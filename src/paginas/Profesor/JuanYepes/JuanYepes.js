...
function Profesor1() {
  return (
    ...
    <div class="Perfil">
        <div class="box">
        <h1>Perfil de Juan Camilo Yepes</h1>
            <div class="Interbox">
                <div class="top"> 
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Juan Camilo Yepes</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> Juan.Yepes@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <br></br>
            <Link to = "/Materias/analisisEstadistico">Analísis estadíst. de datos</Link>
            </div>
        </div>
    </div>

  ...
  return (
    ...
    <div>
        <div class = "Box"> 
            <div class="box1">
                <div class="boox1">
                    <h1> 11310052 - Redes de computadores</h1>
                </div>
                <div class="boox1">
            ...
            <div class="box1"> 
                <div class="boox1">
                    ...
                    <ul> 
                    <Link to='../../Profesor/DavidCeleita/DavidCeleita'><li>David Felipe Celeita</li></Link>
                    <Link to='../../Profesor/JorgeBecerra'><li>Jorge Mario Becerra</li></Link>
                    </ul>
                </div>
            </div>
            ...
            <div class ="box2">
                <div class="boox2">
                    <h1>Repositorios de Redes de computadores</h1>

...
function Profesor1() {
  return (
    ...
    <div class="Perfil">
        <div class="box">
        <h1>Perfil de Cristian Mauricio Martinez</h1>
            <div class="Interbox">
                <div class="top"> 
                    ...
                    <div class ="right">
                        <p><strong>Calificación general:</strong> 3.1/5.0</p>
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Cristian Mauricio Martinez</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> Cristian.Martinez@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <Link to = "/Materias/topología">Topología</Link>
            </div>
        </div>
    </div>

    ...
    <div class="Perfil">
        ...
        <h1>Perfil de Profesor1</h1>
            <div class="Interbox">
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Alexander Cardona</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> Alexander.Cardona@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
                <Link to = "../../Materias/fisica1/fisica1">Física I</Link>
            </div>
        </div>
    </div>

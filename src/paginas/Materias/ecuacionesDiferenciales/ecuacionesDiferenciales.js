  ...
  return (
    ...
    <div>
        <div class = "Box"> 
            <div class="box1">
                <div class="boox1">
                    <h1> 11310016 - Ecuaciones Diferenciales</h1>
                </div>
                <div class="boox1">
            ...
            <div class="box1"> 
                <div class="boox1">
                    ...
                    <ul> 
                    <Link to='../../Profesor/LuzEcheverry/LuzEcheverry'><li>Luz Myriam Echeverry</li></Link>
                    <Link to='../../Profesor/MiguelPachon/MiguelPachon'><li>Miguel Angel Pachon</li></Link>
                    </ul>
                </div>
            </div>
            ...
            <div class ="box2">
                <div class="boox2">
                    <h1>Repositorios de Ecuaciones Diferenciales</h1>

...
function Profesor1() {
  return (
    ...
    <div class="Perfil">
        <div class="box">
        <h1>Perfil de Edwin Camilo Cubides</h1>
            <div class="Interbox">
                <div class="top"> 
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Edwin Camilo Cubides</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong>  Edwin.Cubides@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>

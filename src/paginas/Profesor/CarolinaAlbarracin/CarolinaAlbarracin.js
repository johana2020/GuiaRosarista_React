    ...
    <div class="Perfil">
        ...
        <h1>Perfil de Profesor1</h1>
            <div class="Interbox">
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Carolina Albarracin</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> Carolina.Albarracin@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
            <Link to = "../../Materias/precalculo/precalculo">Precalculo</Link>
            </div>
        </div>
    </div>

...
function Profesor1() {
  return (
    ...
    <div class="Perfil">
        <div class="box">
        <h1>Perfil de David Eugenio Andrade</h1>
            <div class="Interbox">
                <div class="top"> 
                    ...
                    <div class ="right">
                        <p><strong>Calificación general:</strong> 2.5/5.0</p>
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong>David Eugenio Andrade</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong>  David.Andrade@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
                <Link to = "/Materias/calculo2">Cálculo 2</Link>
                <br></br>
                <Link to = "/Materias/calculo3">Cálculo 3</Link>
                <br></br>
                <Link to = "/Materias/probabilidad2">Probabilidad y Estadística II</Link>
                <br></br>
                <Link to = "/Materias/mathModel">Math. Model of Syst</Link>
            </div>
        </div>
    </div>

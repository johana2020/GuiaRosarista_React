        ...
        <h1>Perfil de Henry Naranjo</h1>
            <div class="Interbox">
                <div class="top"> 
                    ...
                    <div class ="right">
                        <p><strong>Calificación general:</strong> 2.6/5.0</p>
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Henry Naranjo</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> Henry.Naranjo@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
                <Link to = "/Materias/precalculo">Precálculo</Link>
                <br></br>
                <Link to = "/Materias/calculo3">Cálculo 3</Link>
                <br></br>
                <Link to = "/Materias/variableCompleja">Variable Compleja</Link>
            </div>
        </div>
    </div>

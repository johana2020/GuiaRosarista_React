...
function Profesor1() {
  return (
    ...
    <div class="Perfil">
        <div class="box">
        <h1>Perfil de Juan Sebastian Rubiano</h1>
            <div class="Interbox">
                <div class="top"> 
                    ...
                    <div class ="right">
                        <p><strong>Calificación general:</strong> 3.0/5.0</p>
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Juan Sebastian Rubiano</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> Juan.Rubiano@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
                <Link to = "/Materias/fisica1">Programación de computadores</Link>
                <br></br>
                <Link to = "/Materias/cornestone">Cornestone Project</Link>
                <br></br>
                <Link to = "/Materias/keystone">Keystone Project</Link>
            </div>
        </div>
    </div>

  ...
  return (
    ...
    <div>
        <div class = "Box"> 
            <div class="box1">
                <div class="boox1">
                    <h1> 11310031 - Probabilidad y estadística 1</h1>
                </div>
                <div class="boox1">
            ...
            <div class="box1"> 
                <div class="boox1">
                    ...
                    <Link to='../../Profesor/CamiloGomez/CamiloGomez'><li>Camilo Alfonso Gomez</li></Link>
                    </ul>
                </div>
            </div>
            ...
            <div class ="box2">
                <div class="boox2">
                    <h1>Repositorios de Probabilidad y estadística 1</h1>

    ...
    <div class="Perfil">
        ...
        <h1>Perfil de Profesor1</h1>
            <div class="Interbox">
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong>  Luz Stella Garcia</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong>  Luz.Garcia@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
                <Link to = "../../Materias/ingenieriaDatos/ingenieriaDatos">Ingeniería de datos</Link>
            </div>
        </div>
    </div>

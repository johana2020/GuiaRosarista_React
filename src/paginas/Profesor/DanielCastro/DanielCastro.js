...
function Profesor1() {
  return (
    ...
    <div class="Perfil">
        <div class="box">
        <h1>Perfil de Daniel Felipe Castro</h1>
            <div class="Interbox">
                <div class="top"> 
                    ...
                    <div class ="right">
                        <p><strong>Calificación general:</strong> 3.5/5.0</p>
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Daniel Felipe Castro</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> Daniel.Castro@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
                <Link to = "/Materias/pensamientoMatematico">Pensamiento matemático</Link>
                <br></br>
                <Link to = "/Materias/logicaTeoNumeros">Lógica, teoría de números y conjuntos</Link>
                <br></br>
                <Link to = "/Materias/optimizacion/optimizacion">Optimización</Link>
                <br></br>
                <Link to = "/Materias/topologia">Topología</Link>
            </div>
        </div>
    </div>

  ...
  return (
    ...
    <div>
        <div class = "Box"> 
            <div class="box1">
                <div class="boox1">
                    <h1> 11310006 - Algoritmos y estructura de datos</h1>
                </div>
                <div class="boox1">
            ...
            <div class="box1"> 
                <div class="boox1">
                    ...
                    <ul> 
                    <Link to='../../Profesor/RicardoGarzon'><li>Ricardo Andres Garzon</li></Link>
                    <Link to='../../Profesor/PedroWightman'><li>Pedro Mario Wightman</li></Link>
                    <Link to='../../Profesor/LuisSeijas'><li>Luis Eduardo Seijas</li></Link>
                    </ul>
                </div>
            </div>
            ...
            <div class ="box2">
                <div class="boox2">
                    <h1>Repositorios de Algoritmos y estructuras de datos</h1>

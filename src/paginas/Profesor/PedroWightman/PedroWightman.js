...
function Profesor1() {
  return (
    ...
    <div class="Perfil">
        <div class="box">
        <h1>Perfil de Pedro Mario Wightman</h1>
            <div class="Interbox">
                <div class="top"> 
                    ...
                    <div class ="right">
                        <p><strong>Calificación general:</strong> 3.4/5.0</p>
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Pedro Mario Wightman</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> Pedro.Wightman@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
                <Link to = "/Materias/algoritmos/algoritmos">Algoritmos y estructura de datos</Link>
                <br></br>
                <Link to = "/Materias/operatingSystems/operatingSystems">Operating Systems</Link>
                <br></br>
                <Link to = "/Materias/capstone/capstone">Capstone Project</Link>
            </div>
        </div>
    </div>

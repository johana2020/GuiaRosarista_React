  ...
  return (
    ...
    <div>
        <div class = "Box"> 
            <div class="box1">
                <div class="boox1">
                    <h1> 11310032 - Variable compleja</h1>
                </div>
                <div class="boox1">
            ...
            <div class="box1"> 
                <div class="boox1">
                    ...
                    <ul> 
                    <Link to='../../Profesor/EdwinCubides/EdwinCubides'><li>Edwin Camilo Cubides</li></Link>
                    <Link to='../../Profesor/HernyNaranjo/HernyNaranjo'><li>Herny Naranjo</li></Link>
                    <Link to='../../Profesor/CristianMartinez/CristianMartinez'><li>Cristian Mauricio Martinez</li></Link>
                    </ul>
                </div>
            </div>
            ...
            <div class ="box2">
                <div class="boox2">
                    <h1>Repositorios de Variable compleja</h1>

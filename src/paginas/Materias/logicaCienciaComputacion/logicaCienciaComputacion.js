  ...
  return (
    ...
    <div>
        <div class = "Box"> 
            <div class="box1">
                <div class="boox1">
                    <h1> 11310035 - Lógica para ciencias de la computación </h1>
                </div>
                <div class="boox1">
            ...
            <div class="box1"> 
                <div class="boox1">
                    ...
                    <ul> 
                    <Link to='../../Profesor/EdwinCubines'><li>Edwin Camilo Cubides</li></Link>
                    <Link to='../../Profesor/DanielBojaca'><li>Daniel Alfonso Bojaca</li></Link>
                    </ul>
                </div>
            </div>
            ...
            <div class ="box2">
                <div class="boox2">
                    <h1>Repositorios de Lógica para ciencias de la computación</h1>

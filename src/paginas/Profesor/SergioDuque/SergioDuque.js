    ...
    <div class="Perfil">
        ...
        <h1>Perfil de Profesor1</h1>
            <div class="Interbox">
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Profesor1</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> Profesor.1@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
                <a href="Materia1.html">Materia 1 - 0123456</a>
                <br></br>
                <a href="Materia1.html">Materia 4 - 0123461</a>
                <br></br>
                <a href="Materia1.html">Materia 6 - 0123463</a>
            </div>
        </div>
    </div>

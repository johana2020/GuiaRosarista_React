...
function Profesor1() {
  return (
    ...
    <div class="Perfil">
        <div class="box">
        <h1>Perfil de Luz Myriam Echeverry</h1>
            <div class="Interbox">
                <div class="top"> 
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Luz Myriam Echeverry</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> Luz.Echeverry@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
            <Link to = "/Materias/ecuacionesDiferenciales">Ecuaciones diferenciales</Link>
            </div>
        </div>
    </div>

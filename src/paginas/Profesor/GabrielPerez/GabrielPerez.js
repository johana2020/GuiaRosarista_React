...
function Profesor1() {
  return (
    ...
    <div class="Perfil">
        <div class="box">
        <h1>Perfil de Gabriel Camilo Perez
</h1>
            <div class="Interbox">
                <div class="top"> 
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Gabriel Camilo Perez</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> Gabriel.Perez@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>

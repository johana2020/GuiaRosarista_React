...
function Profesor1() {
  return (
    ...
    <div class="Perfil">
        <div class="box">
        <h1>Perfil de Daniel Alfonso Bojaca</h1>
            <div class="Interbox">
                <div class="top"> 
                    ...
                    <div class ="right">
                        <p><strong>Calificación general:</strong> 5.0/5.0</p>
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Daniel Alfonso Bojaca</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> Daniel.Bojaca@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
                <Link to = "/Materias/logicaCienciaComputacion">Lógica para ciencia de computación</Link>
                <Link to = "/Materias/teoriaGrafos">Teoría de grafos</Link>
            </div>
        </div>
    </div>

  ...
  return (
    ...
    <div>
        <div class = "Box"> 
            <div class="box1">
                <div class="boox1">
                    <h1> 11310042 - Capstone Project</h1>
                </div>
                <div class="boox1">
            ...
            <div class="box1"> 
                <div class="boox1">
                    ...
                    <ul> 
                    <Link to='../../Profesor/SandraOlaya'><li>Sandra Ximena Olaya</li></Link>
                    <Link to='../../Profesor/DavidGonzalez'><li>David Felipe Gonzalez</li></Link>
            ...
            <div class ="box2">
                <div class="boox2">
                    <h1>Repositorios de Capstone Project</h1>

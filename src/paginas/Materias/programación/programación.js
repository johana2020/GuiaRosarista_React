  ...
  return (
    ...
    <div>
        <div class = "Box"> 
            <div class="box1">
                <div class="boox1">
                    <h1> 11310002 - Programación de computadores </h1>
                </div>
                <div class="boox1">
            ...
            <div class="box1"> 
                <div class="boox1">
                    ...
                    <ul> 
                    <Link to='../../Profesor/DanielRambaut'><li>Daniel Felipe Rambaut</li></Link>
                    <Link to='../../Profesor/JuanRubiano'><li>Juan Sebastian Rubiano</li></Link>
            ...
            <div class ="box2">
                <div class="boox2">
                    <h1>Repositorios de Programación de computadores</h1>

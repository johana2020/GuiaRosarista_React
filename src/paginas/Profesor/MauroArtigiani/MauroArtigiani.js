...
function Profesor1() {
  return (
    ...
    <div class="Perfil">
        <div class="box">
        <h1>Perfil de Mauro Artigiani</h1>
            <div class="Interbox">
                <div class="top"> 
                    ...
                    <div class ="right">
                        <p><strong>Calificación general:</strong> 3.8/5.0</p>
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> Mauro Artigiani</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> Mauro.Artigiani@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
                <Link to = "/Materias/teoriaComputacion">Teoría de la computación</Link>
                <br></br>
                <Link to = "/Materias/algebraAbstracta">Álgebra abstracta</Link>
            </div>
        </div>
    </div>

        ...
        <h1>Perfil de Profesor1</h1>
            <div class="Interbox">
                <div class="top"> 
                    ...
                    <div class ="right">
                        <p><strong>Calificación general:</strong> 1.4/5.0</p>
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong>  Luis Eduardo Seijas</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong>  Luis.Seijas@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
                <Link to = "../../Materias/programacion/programacion">Programación de computadores</Link>
                <br></br>
                <Link to = "../../Materias/algoritmos/algoritmos">Algoritmos y estructuras de datos</Link>
            </div>
        </div>
    </div>

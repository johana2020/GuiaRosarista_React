  ...
  return (
    ...
    <div>
        <div class = "Box"> 
            <div class="box1">
                <div class="boox1">
                    <h1> 11310012 - Pensamiento matematico</h1>
                </div>
                <div class="boox1">
            ...
            <div class="box1"> 
                <div class="boox1">
                    ...
                    <ul> 
                    <Link to='../../Profesor/DanielCastro'><li>Daniel Felipe Castro</li></Link>
                    <Link to='../../Profesor/JohnArredondo'><li>John Alexander Arredondo</li></Link>
                    </ul>
                </div>
            </div>
            ...
            <div class ="box2">
                <div class="boox2">
                    <h1>Repositorios de Pensamiento matematico</h1>

...
function Profesor1() {
  return (
    ...
    <div class="Perfil">
        <div class="box">
        <h1>Perfil de David Felipe Celeita</h1>
            <div class="Interbox">
                <div class="top"> 
                ...
                <div class="Bottom">
                    <div>
                        <div class="texto"><strong>Nombre:</strong> David Felipe Celeita</div>
                    </div>
                    <br></br>
                    <div>
                        <div class="texto"><strong>Correo:</strong> David.Celeita@urosario.edu.co</div>
                    </div>
                    <br></br>
                    <div>
...
<div id="openModal" class="modalDialog">
        <div>
            ...
            <h1>Materias</h1>
            <div class="texto">
            <Link to = "/Materias/redesComputadores">Redes de computadores</Link>
            </div>
        </div>
    </div>
